...
img_ajoloteGaussian = cv2.GaussianBlur(img_ajolote_noise, (5,5), 1, borderType= cv2.BORDER_CONSTANT)
img_lola_gaussian = cv2.GaussianBlur(img_lola_noise, (5,5), 1, borderType= cv2.BORDER_CONSTANT)
img_pez_gausssian = cv2.GaussianBlur(img_pez_noise, (5,5), 1, borderType= cv2.BORDER_CONSTANT)
img_chapala_gaussian = cv2.GaussianBlur(img_chapala_noise,(5,5), 30, borderType= cv2.BORDER_CONSTANT)
img_chucky_gaussian = cv2.GaussianBlur(img_chucky_noise,(5,5),30, borderType= cv2.BORDER_CONSTANT)
img_paloma_gaussian = cv2.GaussianBlur(img_paloma_noise,(5,5),30, borderType= cv2.BORDER_CONSTANT)
img_serpiente_gaussian = cv2.GaussianBlur(img_serpiente_noise, (5,5), 5, borderType= cv2.BORDER_CONSTANT)

img_chapala_laplacian = cv2.Laplacian(img_chapala_gaussian, cv2.CV_64F, ksize= 5)
...
img_serpiente_laplacian = cv2.Laplacian(img_serpiente_gaussian, cv2.CV_64F, ksize= 5)
